...
model_dir = 'Python Capstone Projects/Housing_Regressor'
models = {name: pickle.load(open(os.path.join(model_dir, f'{name}.pkl'), 'rb')) for name in model_names}

#Load Evaluation Results
results_file = os.path.join('Python Capstone Projects', 'Housing_Regressor', 'Model_Evaluation_Results.csv')
results_df = pd.read_csv(r'C:\Users\HP\A VS Code\Python Capstone Projects\Housing_Regressor\Model_Evaluation_Results.csv')
